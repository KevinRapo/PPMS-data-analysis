...
def checkMeasurementType(measurement_table, discrete_detection_ration = 0.02):
...
def createList_meanTimes10(measurement_table, discrete_detection_ration = 0.02):
    ...
    muutuja = rounded_dataset_T.value_counts() > meanTempCount*10
    print("meantemp  ")
    print(meanTempCount*10)
    print(">>")
    print(rounded_dataset_T.value_counts())
    ...
    muutuja2 = rounded_dataset_H.value_counts() > meanFieldCount*10
    print("meanfield  ")
    print(meanFieldCount*10)
    print(">>")
    print(rounded_dataset_H.value_counts()) 

    magnetic_fields_of_interest = pd.Series(rounded_dataset_H.value_counts()[muutuja2].index.values)
    
    return temperatures_of_interest, magnetic_fields_of_interest

def createList(measurement_table, discrete_detection_ration = 0.07):
    rounded_dataset_T = measurement_table["Temperature (K)"].round(decimals=1)
    rounded_dataset_H = measurement_table["Magnetic Field (Oe)"].round(decimals=1)
    ...
    if temperatures_of_interest.size <= 0 and magnetic_fields_of_interest.size <=0 :
        
        print('temperatures_of_interest.size <= 0 -----------------------------------------------------')
...
print("_________chechMeasurementType-----------")
...
temperatures_of_interest, fields_of_interest= checkMeasurementType2(ORIGINAL_DATAFRAME)
print(temperatures_of_interest, fields_of_interest)
print("_________end-----------")
...
#     a = ORIGINAL_DATAFRAME["Temperature (K)"].round(decimals=1).value_counts()
#     TEMPERATURES_OF_INTEREST = pd.concat([TEMPERATURES_OF_INTEREST,pd.Series(a.index.values)], ignore_index = True)
...
#     b = ORIGINAL_DATAFRAME["Magnetic Field (Oe)"].round(decimals=1).value_counts()
#     pd.Series(b.index.values)
#     MAGNETIC_FIELDS_OF_INTEREST = pd.concat([MAGNETIC_FIELDS_OF_INTEREST,pd.Series(b.index.values)], ignore_index = True)
...
# print("Kontroll huvitapkkuvad temperatuurid")
# print(TEMPERATURES_OF_INTEREST)
# print(ORIGINAL_DATAFRAME["Temperature (K)"].round(decimals=1).value_counts()[muutuja].index.values)
# #ORIGINAL_DATAFRAME["Temperature (K)"].round(decimals=1).value_counts()[muutuja].index.toSeries()

# meanFieldCount=ORIGINAL_DATAFRAME["Magnetic Field (Oe)"].round(decimals=1).value_counts().mean()
# muutuja2 = ORIGINAL_DATAFRAME["Magnetic Field (Oe)"].round(decimals=1).value_counts() > meanFieldCount*10
# print("Kontroll huvitapkkuvad magnetväljad")
# print(MAGNETIC_FIELDS_OF_INTEREST)
# print(ORIGINAL_DATAFRAME["Magnetic Field (Oe)"].round(decimals=1).value_counts()[muutuja2].index.values)

print("***************************************************")
print("funktsioon createList_meanTimes10: ")
print(createList_meanTimes10(ORIGINAL_DATAFRAME))
print("***************************************************")
print("***************************************************")
print("funktsioon creatlist: ")
print(createList(ORIGINAL_DATAFRAME))
print("***************************************************")



# #TEMP_SERIES, FIELD_SERIES = createList(ORIGINAL_DATAFRAME)

# if TEMP_SERIES.size <= 0 and FIELD_SERIES.size <=0 :
#     # eelda et on ühe mõõtmeline
#     print()
